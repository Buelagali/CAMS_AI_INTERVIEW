...
const skillKnowledgeGraph = {
  ...
  'DevOps Engineer': {
    core: ['Docker', 'Kubernetes', 'CI/CD', 'Linux', 'Git', 'AWS', 'Scripting'],
    advanced: ['Terraform', 'Ansible', 'Helm', 'Prometheus', 'Grafana', 'Istio'],
    projects: ['Infrastructure as Code', 'Monitoring Stack', 'Deployment Pipeline', 'Container Orchestration'],
  },
  'Data Engineer': {
    core: ['Python', 'SQL', 'ETL', 'Data Warehousing', 'Apache Spark', 'Linux'],
    advanced: ['Apache Airflow', 'Kafka', 'Snowflake', 'dbt', 'BigQuery', 'Data Lakes'],
    projects: ['Data Pipeline', 'Warehouse Migration', 'Streaming Pipeline', 'Data Lake'],
  },
  'Frontend Developer': {
    core: ['JavaScript', 'TypeScript', 'React', 'HTML', 'CSS', 'Git', 'REST APIs'],
    advanced: ['Next.js', 'Vue.js', 'Webpack', 'Testing', 'Accessibility', 'Performance Optimization'],
    projects: ['Single Page App', 'Design System', 'Progressive Web App', 'Component Library'],
  },
  'Mobile Developer': {
    core: ['JavaScript', 'TypeScript', 'React Native', 'Git', 'REST APIs', 'Mobile UI'],
    advanced: ['iOS', 'Android', 'Flutter', 'App Store Deployment', 'Push Notifications', 'Offline Storage'],
    projects: ['Mobile App', 'Cross-Platform App', 'App Store Launch', 'Mobile API Integration'],
  },
  'Site Reliability Engineer': {
    core: ['Linux', 'Docker', 'Kubernetes', 'CI/CD', 'Monitoring', 'Networking', 'Scripting'],
    advanced: ['Chaos Engineering', 'Capacity Planning', 'Service Mesh', 'Observability', 'Incident Management', 'SLO/SLI'],
    projects: ['Incident Response Runbook', 'SLO Dashboard', 'Chaos Experiment', 'Auto Scaling'],
  },
};
...
const skillRelationships = {
  prerequisite: {
    ...
    'Ansible': ['Linux', 'Scripting'],
    'Helm': ['Kubernetes'],
    'Prometheus': ['Linux', 'Monitoring'],
    'Grafana': ['Prometheus'],
    'Istio': ['Kubernetes'],
    'Apache Airflow': ['Python', 'Linux'],
    'Kafka': ['Linux', 'Networking'],
    'Snowflake': ['SQL', 'Data Warehousing'],
    'dbt': ['SQL', 'Python'],
    'BigQuery': ['SQL', 'Cloud basics'],
    'Next.js': ['React', 'JavaScript'],
    'Vue.js': ['JavaScript', 'HTML', 'CSS'],
    'Webpack': ['JavaScript'],
    'React Native': ['JavaScript', 'React', 'Mobile UI'],
    'Flutter': ['Dart', 'Mobile UI'],
    'iOS': ['Swift', 'Mobile UI'],
    'Android': ['Kotlin', 'Mobile UI'],
    'Chaos Engineering': ['Kubernetes', 'Monitoring'],
    'Service Mesh': ['Kubernetes', 'Networking'],
    'Observability': ['Monitoring', 'Prometheus'],
    'Incident Management': ['Monitoring', 'Linux'],
    'Penetration Testing': ['Network Security', 'Linux'],
    'Incident Response': ['Network Security', 'Linux'],
    'Forensics': ['Linux', 'Cryptography'],
    'Cloud Security': ['Network Security', 'Cloud basics'],
  },
  complementary: [
    ['TypeScript', 'React'],
    ['Docker', 'CI/CD'],
